...
call MyHighlight('Constant'    , _mgreen, _none , 'none')
call MyHighlight('Type'       , _red, _none , 'none') "class name
call MyHighlight('Function'   , _red, _none , 'none')
call MyHighlight('Delimiter'   , _green, _none , 'none')
call MyHighlight('Operator'   , _green, _none , 'none')
